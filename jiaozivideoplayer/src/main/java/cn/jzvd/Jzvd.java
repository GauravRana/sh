...
public abstract class Jzvd extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    public static int NORMAL_ORIENTATION = ActivityInfo.SCREEN_ORIENTATION_SENSOR_LANDSCAPE;
    ...
    public RelativeLayout progress_layer;
...
//        mAudioManager.setStreamMute(AudioManager.STREAM_MUSIC, true);
    ...
    public void startVideo_with_scaling() {
        JzvdMgr.completeAll();
        Log.d(TAG, "startVideo [" + this.hashCode() + "] ");
        initTextureView();
        addTextureView();
