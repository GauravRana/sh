...
public class RadioAudioAdapter extends RecyclerView.Adapter<RadioAudioAdapter.AudioAdapterViewHolder> {
    private static final String TAG = RadioAudioAdapter.class.getSimpleName();
    private static OnItemClickListener mListener;
    private List<JcAudio> jcAudioList;
    private SparseArray<Float> progressMap = new SparseArray<>();

    public RadioAudioAdapter(List<JcAudio> jcAudioList) {
